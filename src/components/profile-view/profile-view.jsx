...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios.get(`https://noahs-movie-app.herokuapp.com/users/${username}`, {
  ...
  removeFavouriteMovie(movie) {
    ...
    axios
      .delete(`https://noahs-movie-app.herokuapp.com/users/${username}/movies/${movie._id}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
  ...
  handleUpdate(e, newName, newUsername, newPassword, newEmail, newBirthdate) {
    ...
    axios.put(`https://noahs-movie-app.herokuapp.com/users/${username}`, {
      headers: { Authorization: `Bearer ${token}` },
      data: {
  ...
  handleDeleteUser(e) {
    ...
    axios.delete(`https://noahs-movie-app.herokuapp.com/users/${username}`, {
      headers: { Authorization: `Bearer ${token}` },
    })
      .then(() => {
        ...
        {FavoriteMovies.length === 0 && <div className="text-center">Empty.</div>}
            ...
            {FavoriteMovies.length > 0 &&
              movies.map((movie) => {
                ...
                favMovie === movie._id)) {
                  ...
                  return (
                    <CardGroup key={movie._id} className="movie-card-deck">
          ...
          <h1 className="Profile">Update Profile</h1>
            <Form noValidate validated={validated} className="update-form" onSubmit={(e) => 
              this.handleUpdate(e, this.Name, this.Username, this.Password, this.Email, this.Birthdate)}>

              <Form.Group controlId="formName">
                <Form.Label className="form-label">Name</Form.Label>
                <Form.Control type="text" placeholder="Change Name" onChange={(e) => 
              ...
              <Form.Group controlId="formBirthday">
                ...
                <Form.Control type="date" placeholder="Change Birthdate" onChange={(e) => 
